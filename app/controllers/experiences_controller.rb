class ExperiencesController < ApplicationController
  ...
  def index
    @experiences = Experience.paginate(:page => params[:page], :per_page => 2).order('created_at DESC')
  ...
  def create
    ...
    respond_to do |format|
      if @experience.save
        format.html { redirect_to :back, notice: 'Experience was successfully created.' }
